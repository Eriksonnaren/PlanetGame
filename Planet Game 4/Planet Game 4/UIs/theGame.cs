...
namespace Planet_Game_4
{
    public class theGame : ui
    {
        ...
        public bool worldDispBox = false; // If this is true, display a box that shows where the world is rendered
        ...
        public void show()
        {
            ...
            if(worldDispBox)
            {
                graphics.DrawRectangle(new Pen(Color.White), (int)(worldDisplay.min.X), (int)(worldDisplay.min.Y), (int)(worldDisplay.size.X), (int)(worldDisplay.size.Y));
            }
